...
这里假定 $x$ 是网络的某一激活层特征，我们要对其进行归一化。若模型训练batch中共有![[公式]](https://www.zhihu.com/equation?tex=n)个样例，其特征分别是![[公式]](https://www.zhihu.com/equation?tex=%7Bx_1%2C+x_2%2C+%5Cldots%2C+x_n%7D) ，我们采用下列公式进行归一化： 
$$
